...
if ((int)$_SESSION['role'] == 0) {
    header("Location:" . $REDIRECT_URL_BEFORE_LOGIN);
} else {
...
<div id="admin-content">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="admin-heading" style="text-align: center ; text-decoration: underline; text-shadow: 2px 2px #FF0000;">Add User</h1>
            </div>
